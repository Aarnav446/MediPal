      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {/* 'For Doctors' link removed as requested */}
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
                <div className="flex items-center gap-4">
                    {user.role === 'admin' && (
                        <a href="#/admin-dashboard" className="hidden md:flex items-center gap-2 px-4 py-2 bg-slate-800 text-white rounded-lg text-sm font-semibold hover:bg-slate-900 transition-colors">
                            Admin Panel
                        </a>
                    )}
